...
- Workflows Flatpak, Release, benchmark et CodeQL actifs. CodeQL a réussi sur le
  commit documentaire courant `82a8a16` ; le smoke Flatpak a réussi sur le
  commit code `82a8a16` (run `34253665599`). Ces jobs ne remplacent pas les
