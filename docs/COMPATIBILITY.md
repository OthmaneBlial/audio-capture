...
| --- | --- | --- |
| x86_64 Flatpak build/install/remove | Clean GNOME 50 container workflow; run `34251681866` on commit `7d30bf4` passed with pinned actions/image, build, offline rebuild, lints, GTK/Xvfb smoke, and data removal | Automated package evidence; no physical desktop claim |
