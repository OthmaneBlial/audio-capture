...
| --- | --- | --- |
| x86_64 Flatpak build/install/remove | Clean GNOME 50 container workflow; run `34254256484` on commit `cfcc9e6` passed with pinned actions/image, build, offline rebuild, lints, GTK/Xvfb smoke, and data removal | Automated package evidence; no physical desktop claim |
