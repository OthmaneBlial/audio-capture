...
Voice Transcriber `v0.4.0` publishes one `x86_64` bundle built from the matching
...
The `v0.4.0` tag, `main.py`, `pyproject.toml`, AppStream release entry, bundle
filename, and release title all use `0.4.0`. GitHub Actions builds the manifest
